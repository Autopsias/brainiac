...
6. `dist/cowork-skills/curation.skill`
7. `dist/cowork-skills/improve.skill`
8. `dist/cowork-skills/task-registrar.skill`
...
code, not just documented (`tests/test_s06_integration.py`).
...
- [ ] **Skills uploaded** — at minimum the 5 kernel `.skill` zips are saved
