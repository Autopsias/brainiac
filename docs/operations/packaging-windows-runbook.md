...
**Session:** S07 · **Date:** 2026-06-27 · **Repo:** `profile-a-brain/`
**Scope:** how a **locked, Defender-managed, Intune-enrolled Example Corp Windows
...
- **Region gating (verify FIRST):** Public-Trust identities issue only from
  US/CA/EU/UK billing regions — confirm the Example Corp tenant is eligible at PW-2.
