...
> before-fleet checkpoint. Role labels (Example Corp EUC, Example Corp Cyber) follow the vault
...
| Activity | maintainer (CTO) | 2nd operator (TBD) | Example Corp EUC (Intune) | Example Corp Cyber (CISO) | Post-ship owner (TBD) |
|---|:--:|:--:|:--:|:--:|:--:|
...
| Sign + release approval | maintainer | Example Corp Cyber (TBD named) |
| Production incident / quarantine | Post-ship owner (TBD) | Example Corp EUC on-call |
