...
Design constraints honoured (design v5 §5 + S05 hardening):
  ...
  * Graded qrels 0-3 keyed on the CANONICAL SOURCE PATH (the real Acme-vault
...
All qrel paths are real paths from the live Acme vault (cross-checked against
...
# documented as such.)
ENTITY_WHITELIST = {
    "northwind", "contoso", "acme", "petroco", "ventura", "fabrikam", "brightwell",
...
add(id="xl_pt_06", lang="EN", target_lang="PT", stratum="cross_lingual_en_pt",
    ...
    qrels=[{"path": "00 Inbox/2026-06-23-20260416-Acme-corporate-functions-adjusted-rationales-slides-rationale-org-transition.md", "grade": 3}])
...
add(id="mh_10", lang="EN", stratum="multi_hop", held_out=False, provenance="past-query-log",
    text="What does the AI-native strategy for Acme Technology say about the agentic operating model?",
    qrels=[{"path": "30 Projects/Acme Technology AI-Native Strategy.md", "grade": 3},
...
add(id="pt_04", lang="PT", stratum="monolingual_pt", held_out=False, provenance="ragas-verified",
    text="Onde está a análise da escolha greenfield de Tier 2 entre Acme e Northwind?",
    qrels=[{"path": "50 Sources/Analysis Tier 2 Acme Northwind Greenfield Choice.md", "grade": 3},
           {"path": "50 Sources/Analysis Tier 2 Acme Northwind Greenfield Choice Deck.md", "grade": 2}])
...
add(id="pt_08", lang="PT", stratum="monolingual_pt", held_out=False, provenance="ragas-verified",
    text="Qual é a relação da Acme com a Northwind no projeto Meridian?",
...
def main() -> int:
    ...
    doc = {
        ...
        "created": "2026-06-27",
        "session": "s05",
        "canonical_key": "source_path (real Acme-vault relative path); both systems "
