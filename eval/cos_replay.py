...
from cos_replay_prompt import (  # noqa: E402  (facade re-export)
    DISPOSITIONS as DISPOSITIONS,
    _apply_window as _apply_window,
    _BAR_OVERRIDE as _BAR_OVERRIDE,
    _CONFIG_DEFAULTS as _CONFIG_DEFAULTS,
    _OUTPUT_SCHEMA as _OUTPUT_SCHEMA,
    _PREAMBLE as _PREAMBLE,
    build_prompt as build_prompt,
    extract_doctrine as extract_doctrine,
