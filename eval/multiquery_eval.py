...
VAULT = os.environ.get("BRAIN_VAULT", str(REPO / "vault"))

# Accurate EN reformulations of the PT/ES golden queries (translated by a fluent
# speaker; this is the "agent reformulates cross-lingually" step). Synthetic set —
# ids match eval/build_golden_set.py.
EN = {
    "xl_pt_01": "Which vector model was chosen for semantic search?",
    "xl_pt_02": "Where is the explanation of the note sensitivity gate?",
    "xl_es_01": "How are responsibilities split between the host and the isolated VM?",
    "pt_01": "What does the brain engine and its command line do?",
    "pt_02": "What does the brain note index contain?",
    "pt_03": "How does the note sensitivity gate work?",
    "es_01": "What does the brain engine and its CLI do?",
    "es_02": "How are responsibilities divided between the host and the VM?",
}
