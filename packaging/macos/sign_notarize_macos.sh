...
# correct and runnable, but only completes on a machine signed into the Example Corp
# Apple Developer account.
#
# Prereqs (all PENDING the Apple ID):
#   - "Developer ID Application: <Example Corp> (<TEAMID>)" cert in the login keychain
...
: "${DEV_ID:?set DEV_ID to 'Developer ID Application: <Example Corp> (<TEAMID>)'}"
