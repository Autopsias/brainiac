...
# GRH-01 hygiene fold lives in graph_hygiene.py since the 2026-08-16 size
# ratchet; re-exported here so `brain.graph.graph_hygiene_metrics` (the name
# every caller and test uses) keeps working.
from .graph_hygiene import (  # noqa: E402,F401  (facade re-export)
    _GENERATED_MAP_BASENAMES as _GENERATED_MAP_BASENAMES,
    _connected_components as _connected_components,
    graph_hygiene_metrics as graph_hygiene_metrics,
)
