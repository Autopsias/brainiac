...
def _read_pages(reader: object, ocr_budget: int) -> tuple[list[str], list[int], list[int], int]:
    ...
    scanned: list[int] = []
    ocred: list[int] = []
    for i, page in enumerate(reader.pages, start=1):  # type: ignore[attr-defined]
