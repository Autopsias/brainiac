...
# barred for Example Corp commercial use). Loaded DIRECTLY via ONNX Runtime + tokenizers
...
def get_reranker(prefer: str = "noop") -> Reranker:
    ...
    CC-BY-NC jina-v2 catalogue path — AVOID for Example Corp commercial use).
