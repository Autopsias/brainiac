...
STRONG = re.compile(
    r"\b(Northwind|Contoso|Ventura|Fabrikam|Meridian|MNPI|material non[- ]public|"
    r"RetainedCo|technology separation|technology segregation|separation|"
    r"service agreement|term ?sheet|valuation|due diligence|merger|acquisition|M&A|"
    r"pre[- ]?signing|not[- ]to[- ]exceed|\bPhase[- ]?0\b|\bDay[- ]?1\b|"
